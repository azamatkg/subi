      ...
      <div className='flex items-center gap-4 mb-6'>
        ...
        <div>
          <h1 className='text-3xl font-bold'>
            {t('navigation.commissionReviews')}
          </h1>
      ...
      <div className='grid gap-6 mb-6 md:grid-cols-3'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>На следующей неделе</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className='grid gap-6'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Многомембернальная оценка заявок с агрегацией финальных
              результатов
            </CardDescription>
          </CardHeader>
          <CardContent>
