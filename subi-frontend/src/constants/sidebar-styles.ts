export const sidebarStyles = {
  ...
  content: {
    ...
    header: 'flex items-center justify-between p-4 h-16 border-b border-gray-800 bg-gray-900 relative',
  ...
  header: {
    ...
    collapseButton: 'h-8 w-8 p-0 hover:bg-gray-800 rounded-full border border-gray-700 shadow-sm z-10',
  ...
  section: {
    ...
    trigger: {
      expanded: 'w-full justify-between px-3 py-2 h-auto text-xs font-semibold text-gray-400 uppercase tracking-wider hover:bg-gray-700 hover:text-gray-300 transition-colors',
