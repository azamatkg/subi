...
interface RepaymentOrderCardProps {
  repaymentOrder: RepaymentOrderResponseDto;
...
export const RepaymentOrderCard: React.FC<RepaymentOrderCardProps> = ({
  repaymentOrder,
  onView,
  onEdit,
  onDelete,
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1 flex-wrap">
                ...
                {/* Priority badges removed as they're not supported by current API */}
              </div>
              <h3 className="text-lg font-semibold text-gray-900 truncate">
                {repaymentOrder.nameEn}
              </h3>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium">{formatDate(repaymentOrder.createdAt)}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium">{formatDate(repaymentOrder.updatedAt)}</p>
            </div>
          </div>
        </div>

        {repaymentOrder.createdByUsername && (
          <div className="mt-3 pt-3 border-t border-gray-100">
            <p className="text-xs text-gray-500">
              {t('common.by')} {repaymentOrder.createdByUsername}
            </p>
          </div>
        )}
      </CardContent>
