...
import { Shield, Users, TrendingUp, Eye, ArrowUpRight } from 'lucide-react';
...
export const ActiveRolesCard: React.FC<ActiveRolesCardProps> = ({
  ...
  const totalActiveUsers = roles.reduce(
    (sum, role) => sum + role.activeUsers,
    0
  );
        ...
        <div className='space-y-4'>
          ...
          <div className='pt-3 border-t border-border/50'>
            <div className='flex items-center justify-between text-sm'>
              <span className='text-muted-foreground'>Всего ролей активно</span>
              <div className='flex items-center gap-2'>
                <Badge variant='outline' className='font-mono'>
                  {displayedRoles.filter(r => r.activeUsers > 0).length}/
